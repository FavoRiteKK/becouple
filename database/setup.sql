...
-- Thứ sáu, 05 Tháng một Năm 2018 17:42:36 +07
...
CREATE TABLE IF NOT EXISTS `app_mvp_dating`.`user` (
  ...
  `living_at` VARCHAR(255) NULL DEFAULT NULL,
  `home_town` VARCHAR(255) NULL DEFAULT NULL,
  `working_at` VARCHAR(255) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `app_mvp_dating`.`credentials`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `app_mvp_dating`.`credentials` (
  `create_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` TIMESTAMP NULL DEFAULT NULL,
