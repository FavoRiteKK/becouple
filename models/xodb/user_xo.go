...
type User struct {
	...
	AvatarURI          sql.NullString `json:"avatar_uri"`           // avatar_uri
	...
	Job                sql.NullString `json:"job"`                  // job
	LivingAt           sql.NullString `json:"living_at"`            // living_at
	HomeTown           sql.NullString `json:"home_town"`            // home_town
	WorkingAt          sql.NullString `json:"working_at"`           // working_at
	ShortAbout         sql.NullString `json:"short_about"`          // short_about
	Height             sql.NullInt64  `json:"height"`               // height
	Weight             sql.NullInt64  `json:"weight"`               // weight
	Status             Status         `json:"status"`               // status
	Oauth2UID          sql.NullString `json:"oauth2_uid"`           // oauth2_uid
	Oauth2Provider     sql.NullString `json:"oauth2_provider"`      // oauth2_provider
	Oauth2Token        sql.NullString `json:"oauth2_token"`         // oauth2_token
	Oauth2Refresh      sql.NullString `json:"oauth2_refresh"`       // oauth2_refresh
	Oauth2Expiry       mysql.NullTime `json:"oauth2_expiry"`        // oauth2_expiry
	ConfirmToken       sql.NullString `json:"confirm_token"`        // confirm_token
...
func (u *User) IsDeleted() bool {
	return u.Deleted.Valid && u.Deleted.Bool == true
}
...
func UserByPhoneNumber(db XODB, phoneNumber sql.NullString) (*User, error) {
	var err error
