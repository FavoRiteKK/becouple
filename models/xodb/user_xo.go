...
type User struct {
	...
	Oauth2Refresh      string         `json:"-"`             // oauth2_refresh
	Oauth2Expiry       mysql.NullTime `json:"-"`             // oauth2_expiry
	ConfirmToken       string         `json:"-"`             // confirm_token
	Confirmed          bool           `json:"confirmed"`     // confirmed
	AttemptNumber      uint8          `json:"-"`             // attempt_number
	AttemptTime        mysql.NullTime `json:"-"`             // attempt_time
	Locked             mysql.NullTime `json:"locked"`        // locked
	RecoverToken       string         `json:"-"`             // recover_token
	RecoverTokenExpiry mysql.NullTime `json:"-"`             // recover_token_expiry
...
// custom implementation of convert User struct to JSON
func (u *User) MarshalJSON() ([]byte, error) {
	type JSONUser User

	var _phoneNumber interface{}
	if u.PhoneNumber.Valid {
		_phoneNumber = u.PhoneNumber.String
	}
	...
	if u.Locked.Valid {
		_locked = u.Locked.Time
	}

	return json.Marshal(&struct {
		Password    string      `json:"password"`      // password
		PhoneNumber interface{} `json:"phone_number"`  // phone_number
		DateOfBirth interface{} `json:"date_of_birth"` // date_of_birth
		Locked      interface{} `json:"locked"`        // locked
		*JSONUser
	}{
