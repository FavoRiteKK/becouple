...
type UserAnswerQuestion struct {
	...
	SelfAnswer   string `json:"self_answer"`   // self_answer
	ExpectAnswer string `json:"expect_answer"` // expect_answer
	HateAnswer   string `json:"hate_answer"`   // hate_answer
	AlsoAsk      bool   `json:"also_ask"`      // also_ask
